...
namespace skipper_backend.Migrations
{
    ...
    [Migration("20240110151824_editskillsm")]
    partial class editskillsm
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "0daba943-73f4-4d49-97b0-4d42425533ff",
                            Name = "Member",
                            NormalizedName = "MEMBER"
                        },
                        new
                        {
                            Id = "26a14874-6392-4222-91e9-168ae320e8b3",
                            Name = "Admin",
            ...
            modelBuilder.Entity("skipper_backend.Models.SkillsMatrix.SkillsMatrixSingleSkillInput", b =>
                {
                    b.HasOne("skipper_backend.Models.SkillsMatrix.SkillsMatrixInput", "SkillsMatrixInput")
                        .WithMany("Inputs")
                        .HasForeignKey("SkillsMatrixInputID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SkillsMatrixInput");
                });
